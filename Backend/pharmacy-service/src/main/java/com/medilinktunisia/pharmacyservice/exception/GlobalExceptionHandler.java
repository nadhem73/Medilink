...
/**
 * Gestionnaire global des exceptions pour le service pharmacy
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePharmacyNotFoundException(PharmacyNotFoundException ex) {
        log.error("Pharmacy not found: {}", ex.getMessage());
